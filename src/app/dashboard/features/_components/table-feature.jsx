...
export default function TableFeature({ features, onDeleteButtonClick }) {
  return (
    <Table className="mt-4">
      <TableHeader>
        <TableRow>
          <TableHead className="w-48">Image</TableHead>
          <TableHead className="min-w-28">Title</TableHead>
          ...
          <TableRow key={feature.id}>
            ...
            <TableCell>
              <Button asChild variant="secondary" className="mr-2">
                <Link href={URL.DASHBOARD_FEATURES_EDIT(feature.id)}>
                  <Pencil />
                </Link>
              </Button>
              <Button
